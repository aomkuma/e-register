...
function getYearOfBirthList(loop)
{
    ...
    var startYear = dateObj.getFullYear();// - 100;
    var yearList = [];
    for(var i =0 ; i < 100; i++){
        yearList.push({'yearValue': ((startYear - i) + 543), 'yearText' : startYear - i});
    }
...
function getTotalDayInMonth(month, year){
    ...
    if(month != null && year != null){
        // console.log('asd ' + getMaxDayInMonth(month, year));
        maxDay = getMaxDayInMonth(month, year);
    }
    var dayList = [];
...
app.controller('ModalDialogPreventCtrl', function ($scope, $uibModalInstance, params) {
    // console.log(params);
...
app.filter('FindProvinceID', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
                //console.log(input[i].UserID, '==' ,val);
                if (input[i].PROVINCE_ID == val) {
                    return i;
                }
            }
            return -1;
...
app.filter('FindProvinceName', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
...
app.filter('FindAmphurID', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
                //console.log(input[i].UserID, '==' ,val);
                if (input[i].AMPHUR_ID == val) {
                    return i;
                }
            }
            return -1;
...
app.filter('FindAmphurName', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
...
app.filter('FindDistrictID', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
                //console.log(input[i].UserID, '==' ,val);
                if (input[i].DISTRICT_ID == val) {
                    return i;
                }
            }
            return -1;
...
app.filter('FindDistrictName', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
...
app.filter('FindQuestion', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            for (; i < len; i++) {
                //console.log(input[i].MenuID, '==' ,val);
                if (input[i].QuestionID == val) {
                    return i;
                }
            }
            return -1;
...
app.filter('CountAnswers', function () {
    return function (input, val) {
        if (input !== undefined && input !== null) {
            var i = 0, len = input.length;
            var cnt = 0;
            for (; i < len; i++) {
                //console.log(input[i].MenuID, '==' ,val);
                if (input[i].QuestionsSection == val) {
                    cnt++;
                }
            }
            return cnt;
